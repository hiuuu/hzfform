...
Decoration getFieldDecoration(
    HZFFormStyle style, HZFFormFieldStatusEnum? status,
    {double? borderWidth = 1.0}) {
  Color backgroundColor;
  Color borderColor;

  switch (status) {
    case HZFFormFieldStatusEnum.error:
      backgroundColor = HZFFormColors.redOpacity;
      borderColor = HZFFormColors.red;
      break;
    case HZFFormFieldStatusEnum.success:
      backgroundColor = HZFFormColors.greenOpacity;
      borderColor = HZFFormColors.green;
      break;
    case HZFFormFieldStatusEnum.normal:
      backgroundColor = style.backgroundFieldColor;
      borderColor = style.fieldBorderColor;
      break;
    case HZFFormFieldStatusEnum.disabled:
      backgroundColor = style.backgroundFieldColorDisable;
      borderColor = style.fieldBorderColor;
      break;
    default:
      backgroundColor = HZFFormColors.white;
      borderColor = HZFFormColors.white;
  }
                      ...
                      child: InkWell(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              cameraName ?? 'Camera',
                              style: HZFFormStyle().titleTextStyle,
                            )
                          ],
                        ),
                      ),
